...
class ReportGeneratorGUI:
    ...
    def create_widgets(self):
        ...
        # Action buttons
        Button(button_frame, text="Load CSV File", command=self.load_file, width=15, height=2).grid(row=0, column=0,
                                                                                                    padx=10)
        Button(button_frame, text="Generate Report", command=self.generate_report, width=15, height=2).grid(row=0,
                                                                                                            column=1,
                                                                                                            padx=10)
